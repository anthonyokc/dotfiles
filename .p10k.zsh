# Generated by Powerlevel10k configuration wizard on 2024-05-27 at 14:55 CDT.
...
() {
  ...
  # prefix. The shortened directory can be tab-completed to the origina
  ...
  function my_git_formatter() {
    ...
    # Show push-remote arrows only if push remote differs from fetch remote
  ...
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION='' # empty
  # Custom prefix.
  ...
  # Load color when load is between 50% and 2%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=3
  # Load color when load is over 2%.
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %2F⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F⇡$P9K_IP_TX_RATE}'
